...
export default function Home() {
  ...
  >
    <div className="flex items-center">
      <button className="mr-2" aria-label="Open Menu" onClick={toggleMenu}>
        <svg
          fill="none"
          stroke="currentColor"
          strokeLinecap="round"
      ...
      <img src="/vercel.svg" alt="vercel" className="h-auto w-24" />
    ...
    <aside
      className={`transform top-0 left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30 ${menu ? "translate-x-0" : "-translate-x-full"}`}
    >
      <span
  
        className="flex w-full items-center p-4 border-b"
      >
        <img src="/vercel.svg" alt="vercel" className="h-auto w-32 mx-auto" />
      </span>
      <span
        onClick={toggleMenu}
